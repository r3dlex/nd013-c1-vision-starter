...
def download_tfr(filepath, temp_dir):
    ...
    args:
        ...
        - temp_dir [str]: path to the directory where the raw data
          will be saved
    returns:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", required=True, help="processed data directory"
    )
    ...
    logger.info(f"Download {len(filenames)} files. This will take a long time.")
    ...
    workers = [
        download_and_process.remote(fn, temp_dir, data_dir)
