...
def get_train_validation_test_split(
    dataset_size: int,
    train_split_percentage: int = 75,
    validate_split_percentage: int = 15,
) -> (int, int, int):
...
def move_train_validation_test_data(
    data_dir: str,
    train_files: [str],
...
if __name__ == "__main__":
    ...
    move_train_validation_test_data(
        args.data_dir, train_files, validation_files, test_files
    )
